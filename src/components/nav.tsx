    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-zinc-200 bg-white/90 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/90">
      <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-4">
        ...
        <div className="hidden items-center gap-1 sm:flex">
          ...
          <button
            onClick={toggleTheme}
            className="p-1.5 text-zinc-400 transition-colors hover:text-zinc-950 dark:hover:text-zinc-50"
        ...
        <button
          ...
          className="p-1.5 text-zinc-500 hover:text-zinc-950 dark:hover:text-zinc-100 sm:hidden"
